...
<html>
  <head>
    ...
    <title>Monitoring KP | Dashboard</title>
    ...
    <section class="no-padding" id="portfolio">
        <div class="container-fluid">
            <div class="row no-gutter">
                ...
                <div class="col-lg-6 col-sm-6">
                    <a href="internship-proposal.html" class="portfolio-box">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2015>APL Kelompok 2</a>.</strong> All rights reserved.
      </footer>
