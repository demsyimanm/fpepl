  ...
  <body class="hold-transition register-page">
    <div class="register-box">
      <div class="register-logo">
        <a href="index2.html"><b>Montoring </b>Kerja Praktek (Dosen)</a>
      </div>

      <div class="register-box-body">
        <p class="login-box-msg">Register a new membership as Lecturer</p>
        ...
        @elseif(Session::has('status') && Session::get('status') == 'register-failed')
          <div class="alert alert-danger alert-dismissible">
            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
            <h4><i class="icon fa fa-ban"></i> Failed!</h4>
            NIP anda tidak mempunyai hak akses ke dalam sistem
          </div>
        @endif
        <form action="{{URL::to('dosen')}}" method="post">
        <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="NIP" name="nrp" required="">
